...
import com.zx.expandedittext.entity.TextEntity;
import com.zx.expandedittext.listener.OnExpandBuildListener;
import com.zx.expandedittext.listener.OnExpandImageClickListener;
import com.zx.expandedittext.loader.GlideImageLoader;
import com.zx.expandedittext.loader.ImageLoader;
import com.zx.expandedittext.utils.BitmapUtils;
import com.zx.expandedittext.utils.DimensUtils;
import com.zx.expandedittext.utils.DipUtils;
import com.zx.expandedittext.utils.EntityUtils;
import com.zx.expandedittext.utils.InputMethodUtils;
import com.zx.expandedittext.wrapper.DefaultImageWrapper;
import com.zx.expandedittext.wrapper.ImageWrapper;
...
public class ExpandEditText extends LinearLayout {
    ...
    public ExpandEditText setTouchListener(OnTouchListener onTouchListener) {
    ...
    public ImageEntity parseImageEntity(String localPath) {
        ...
        int width = DimensUtils.getWidthInPx(getContext()) - DipUtils.dp2px(getContext(), 35);
