 ...
 */
public class HyTagFlowLayout extends FlowLayout
        implements TagAdapter.OnDataSetChangedListener {
    ...
    public HyTagFlowLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public HyTagFlowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HyTagFlowLayout(Context context) {
        this(context, null);
    }
