...
import com.zx.customview.activity.base.BaseActivity;
...
import com.zx.customview.utils.StringUtils;
            ...
            public void subscribe(ObservableEmitter<String> emitter) {
                try{
                    ...
                    for (Uri imageUri : mSelected) {
                        String imagePath = SDCardUtil.getFilePathFromUri(NewActivity1.this,  imageUri);
