...
import com.example.email.EmailTextArea;

/**
 * 仿QQ邮箱中写邮件界面的“收件人”控件，支持模糊查询功能，与QQ的效果基本一致，灵活多用
 * https://github.com/tangjiabing/EmailTextArea
 *
 * 需要进行分析并修改;
 */
public class EmailTextAreaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_email_area);
        ...
        mEmailTextArea.setOnDeleteObjListener(new EmailTextArea.OnDeleteObjListener() {
            @Override
