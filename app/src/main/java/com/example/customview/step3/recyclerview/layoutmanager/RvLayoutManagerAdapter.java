 ...
 *
 */
public class RvLayoutManagerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RvLayoutManagerAdapter(Context context, ArrayList<String> datas) {
        mContext = context;
        mDatas = datas;
