...
import com.example.customview.keyboard.way1.SPUtils;
...
public class EmailConflictView extends LinearLayout {
    ...
    private EditText mContentView;  // 编辑区
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mContentViewId = typedArray.getResourceId(R.styleable.EmailConflictView_contentView, NO_ID);
