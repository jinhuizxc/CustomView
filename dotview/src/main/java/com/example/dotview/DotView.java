...
import com.example.dotview.utils.DotUtil;
...
public class DotView {
    ...
    public DotView(View view, Context context, AttributeSet attr) {
        this.mContext = context;
        this.mView = view;

        TypedArray array = mContext.obtainStyledAttributes(attr, R.styleable.DotView);
    ...
    private void initDot() {
        mDotCircleSpec = DotUtil.dp2px(mContext, DOT_CIRCLE_SPEC);
        mDotOvalWidth = DotUtil.dp2px(mContext, DOT_OVAL_WIDTH);
        mDotNoneCountSpec = DotUtil.dp2px(mContext, DOT_NONE_COUNT_SPEC);
