...
import com.library.adlibrary.utils.DisplayUtil;
...
public class AdManager {
    ...
    public void showAdDialogNoEffect() {
        ...
        animDialogUtils = AnimDialogUtils.getInstance(context)
                ...
                .setOnCloseClickListener(onCloseClickListener)
                .setOverScreen(isOverScreen)
                .initView(contentView);  // 通过布局控制左右屏幕间距;
        setRootContainerHeight();
   ...
   /* private void setRootContainerHeight() {
        ...
        Logger.d("广告宽高 ->widthPixels = " + widthPixels + " heightPixels: " + heightPixels);
        // 广告宽高 ->widthPixels = 1080 heightPixels: 2141
        final int height = (int) (widthPixels / widthPerHeight);
        ViewGroup.LayoutParams params = adRootContent.getLayoutParams();
        params.height = height;
    }*/
