...
public abstract class FlowLayoutAdapter<T> {
    ...
    public View getView(FlowLayout parent, final int position) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(getItemLayoutId(position, list_bean.get(position)),
                        parent, false);
        ...
        // 绑定数据
        bindData(new ViewHolder(view), position, list_bean.get(position));
    ...
    // 填充数据
    public abstract void bindData(ViewHolder holder, int position, T bean);
