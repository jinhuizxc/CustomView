...
import com.example.email.drawable.TextDrawable;
import com.example.email.enity.ChooseObjEntity;
import com.example.email.global.DatabaseGlobal;
import com.example.email.global.DefaultGlobal;
import com.example.email.res.LayoutRes;
import com.example.email.res.ViewRes;
import com.example.email.utils.DbUtil;
import com.example.email.utils.ResUtil;

import java.util.ArrayList;

public class EmailTextArea extends AppCompatMultiAutoCompleteTextView {
