package com.example.email.global;
...
public class DefaultGlobal {
	...
	public static final int DIRTY_SELECTED_TEXT_BG_COLOR = Color.rgb(0xf3,
			0x6b, 0x74);
	public static final int VALID_TEXT_BG_COLOR = Color.rgb(0xd3, 0xe8, 0xfd);
	public static final int VALID_SELECTED_TEXT_BG_COLOR = Color.rgb(0x4a,
			0xa2, 0xe5);
	public static final int TEXT_FG_COLOR = Color.BLACK;
	public static final int SELECTED_TEXT_FG_COLOR = Color.WHITE;
